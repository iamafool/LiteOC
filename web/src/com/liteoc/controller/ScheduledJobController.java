...
import com.liteoc.web.table.scheduledjobs.ScheduledJobTableFactory;
import com.liteoc.web.table.scheduledjobs.ScheduledJobs;
...
public class ScheduledJobController {
    ...
    protected final static Logger logger = LoggerFactory.getLogger("com.liteoc.controller.ScheduledJobController");
    ...
    public String cancelScheduledJob(HttpServletRequest request, HttpServletResponse response,
      ...
      //  newTrigger.setNextFireTime(nextFireTime );
        ...
        else if(triggerGroupName.equals(XsltTriggerService.TRIGGER_GROUP_NAME))
        {
            ...
            jobDetailBean.setJobClass(com.liteoc.job.XsltStatefulJob.class);

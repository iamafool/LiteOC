...
public abstract class AbstractAuditableMutableDomainObject extends AbstractMutableDomainObject implements MutableDomainObject, AuditableMutableDomainObject {
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#getCreatedDate()
     */
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#setCreatedDate(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#getUpdatedDate()
     */
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#setUpdatedDate(java.util.Date)
     */
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#getOwner()
     */
    @Transient
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#setOwner(com.liteoc.bean.login.UserAccountBean)
     */
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#getUpdater()
     */
    @Transient
    ...
    /* (non-Javadoc)
     * @see com.liteoc.domain.AuditableMutableDomainObject#setUpdater(com.liteoc.bean.login.UserAccountBean)
     */

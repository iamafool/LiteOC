    ...
    public void setData(Page page, HttpSession session, HttpServletRequest request) {
        ...
        try {
            ...
            if (page.equals(Page.CREATE_DATASET_1)) {
                ...
                this.setData(resword.getString("items_selected"), Integer.toString(ev_count));
                ...
                this.setData(resword.getString("number_of_questions"), Integer.toString(metadatas.size()));

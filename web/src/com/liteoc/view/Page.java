...
public class Page {
    ...
    public final static Page PRINT_FILTER = new Page("/WEB-INF/jsp/extract/PrintFilter.jsp", "Print Filter");
    /**
     * Page to show errors
     */
    ...
    public final static Page DELETE_STUDY_EVENT = new Page(path + "managestudy/deleteStudyEvent.jsp", "Delete Event from a study");
    ...
    public final static Page VIEW_ALL_DEFAULT_CRF_VERSIONS_PRINT = new Page("/WEB-INF/jsp/managestudy/defaultAllCrfVersionPrint.jsp",
            "View default crf versions print");
    public final static Page VIEW_PRINT_ALL_EVENT_CRF_BY_SUBJID = new Page("/WEB-INF/jsp/managestudy/PrintAllEventCRFBySubjid.jsp",
    		"View all event CRFs by subject ID");

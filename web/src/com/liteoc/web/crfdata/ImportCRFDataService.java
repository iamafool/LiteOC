package com.liteoc.web.crfdata;
...
import com.liteoc.bean.submit.DisplayItemBeanWrapper;
...
import com.liteoc.bean.submit.crfdata.FormDataBean;
import com.liteoc.bean.submit.crfdata.ImportItemDataBean;
import com.liteoc.bean.submit.crfdata.ImportItemGroupDataBean;
import com.liteoc.bean.submit.crfdata.ODMContainer;
import com.liteoc.bean.submit.crfdata.StudyEventDataBean;
import com.liteoc.bean.submit.crfdata.SubjectDataBean;
import com.liteoc.bean.submit.crfdata.SummaryStatsBean;
...
public class ImportCRFDataService {
    ...
    private void attachValidator(DisplayItemBean displayItemBean, ImportHelper importHelper, DiscrepancyValidator v, HashMap<String, String> hardv,
        ...
        com.liteoc.bean.core.ResponseType rt = displayItemBean.getMetadata().getResponseSet().getResponseType();

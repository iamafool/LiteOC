...
import com.liteoc.control.DefaultActionsEditor;
import com.liteoc.controller.helper.SdvFilterDataBean;
import com.liteoc.controller.helper.table.SDVToolbar;
import com.liteoc.controller.helper.table.SubjectSDVContainer;
import com.liteoc.dao.EventCRFSDVFilter;
import com.liteoc.dao.EventCRFSDVSort;
...
public class SDVUtil {
    ...
    */
    ...
    /*public String renderAllEventCRFTable(List<EventCRFBean> eventCRFBeans,
        ...
        ResourceBundle resourceBundle = ResourceBundle.getBundle(
          "com.liteoc.i18n.words",request.getLocale());
    ...
    public String renderEventCRFTableWithLimit(HttpServletRequest request, int studyId, String pathPrefix) {
        ...
        HtmlTable table = (HtmlTable) tableFacade.getTable();
        //i18n caption; TODO: convert to Spring messages
        ResourceBundle resword = ResourceBundle.getBundle("com.liteoc.i18n.words",request.getLocale());
    ...
    */
    ...
    public void prepareSDVSelectElements(HttpServletRequest request, StudyBean studyBean) {
        ...
        for (com.liteoc.domain.Status stat : com.liteoc.domain.Status.values()) {

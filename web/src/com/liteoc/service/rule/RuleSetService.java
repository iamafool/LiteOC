 ...
 */
package com.liteoc.service.rule;
...
import com.liteoc.dao.hibernate.DynamicsItemFormMetadataDao;
import com.liteoc.dao.hibernate.RuleActionRunLogDao;
import com.liteoc.dao.hibernate.RuleDao;
...
import com.liteoc.dao.hibernate.ViewRuleAssignmentFilter;
import com.liteoc.dao.hibernate.ViewRuleAssignmentSort;
...
import com.liteoc.domain.crfdata.DynamicsItemFormMetadataBean;
...
import com.liteoc.domain.rule.RuleSetBasedViewContainer;
...
import com.liteoc.domain.rule.RuleSetRuleBean.RuleSetRuleBeanImportStatus;
...
import com.liteoc.logic.rulerunner.CrfBulkRuleRunner;
import com.liteoc.logic.rulerunner.DataEntryRuleRunner;
import com.liteoc.logic.rulerunner.ExecutionMode;
import com.liteoc.logic.rulerunner.MessageContainer;
import com.liteoc.logic.rulerunner.RuleSetBulkRuleRunner;
...
public class RuleSetService implements RuleSetServiceInterface {
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#saveRuleSet(com.liteoc.domain.rule.RuleSetBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#saveImport(com.liteoc.domain.rule.RulesPostImportContainer)
     */
    @Transactional
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#updateRuleSet(com.liteoc.domain.rule.RuleSetBean,
     * com.liteoc.bean.login.UserAccountBean, com.liteoc.domain.Status)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#loadRuleSetRuleWithPersistentRules(com.liteoc.domain.rule.RuleSetBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#replaceRuleSet(com.liteoc.domain.rule.RuleSetBean)
     */
    public RuleSetBean replaceRuleSet(RuleSetBean ruleSetBean) {
        ...
        for (RuleSetRuleBean ruleSetRuleBean : detachedRuleSetBean.getRuleSetRules()) {
            if (ruleSetRuleBean.getId() != null && ruleSetRuleBean.getRuleSetRuleBeanImportStatus() == RuleSetRuleBeanImportStatus.TO_BE_REMOVED) {
                ruleSetRuleBean.setStatus(com.liteoc.domain.Status.DELETED);
            }
        }
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#runRulesInBulk(java.lang.String, java.lang.Boolean,
     * com.liteoc.bean.managestudy.StudyBean, com.liteoc.bean.login.UserAccountBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#runRulesInBulk(java.lang.String, java.lang.String, java.lang.Boolean,
     * com.liteoc.bean.managestudy.StudyBean, com.liteoc.bean.login.UserAccountBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#runRulesInBulk(java.util.List, java.lang.Boolean,
     * com.liteoc.bean.managestudy.StudyBean, com.liteoc.bean.login.UserAccountBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#runRulesInDataEntry(java.util.List, java.lang.Boolean,
     * com.liteoc.bean.managestudy.StudyBean, com.liteoc.bean.login.UserAccountBean, java.util.HashMap)
     */
     ...
     * (non-Javadoc)
     * @see
     * com.liteoc.service.rule.RuleSetServiceInterface#getRuleSetsByCrfStudyAndStudyEventDefinition(com.liteoc.bean.managestudy.StudyBean,
     * com.liteoc.bean.managestudy.StudyEventDefinitionBean, com.liteoc.bean.submit.CRFVersionBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#getRuleSetsByStudy(com.liteoc.bean.managestudy.StudyBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#getRuleSetById(com.liteoc.bean.managestudy.StudyBean, java.lang.String)
     */
     ...
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#getRuleSetById(com.liteoc.bean.managestudy.StudyBean, java.lang.String,
     * com.liteoc.domain.rule.RuleBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#getRuleSetsByCrfAndStudy(com.liteoc.bean.admin.CRFBean,
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#filterByStatusEqualsAvailableOnlyRuleSetRules(java.util.List)
     */
    public List<RuleSetBean> filterByStatusEqualsAvailableOnlyRuleSetRules(List<RuleSetBean> ruleSets) {
        for (RuleSetBean ruleSet : ruleSets) {
            for (Iterator<RuleSetRuleBean> i = ruleSet.getRuleSetRules().iterator(); i.hasNext();)
                if (i.next().getStatus() != com.liteoc.domain.Status.AVAILABLE) {
                    i.remove();
                }
        }
        return ruleSets;
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#filterByStatusEqualsAvailable(java.util.List)
     */
    public List<RuleSetBean> filterByStatusEqualsAvailable(List<RuleSetBean> ruleSets) {
        for (Iterator<RuleSetBean> j = ruleSets.iterator(); j.hasNext();) {
            ...
            if (ruleSet.getStatus() == com.liteoc.domain.Status.AVAILABLE) {
                for (Iterator<RuleSetRuleBean> i = ruleSet.getRuleSetRules().iterator(); i.hasNext();)
                    if (i.next().getStatus() != com.liteoc.domain.Status.AVAILABLE) {
                        i.remove();
                    }
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#filterByRules(com.liteoc.domain.rule.RuleSetBean, java.lang.Integer)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#filterRuleSetsByStudyEventOrdinal(java.util.List,
     * com.liteoc.bean.managestudy.StudyEventBean)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#solidifyGroupOrdinalsUsingFormProperties(java.util.List, java.util.HashMap)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#filterRuleSetsBySectionAndGroupOrdinal(java.util.List, java.util.HashMap)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#filterRuleSetsByGroupOrdinal(java.util.List)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#getGroupOrdinalPlusItemOids(java.util.List)
     */
    ...
    /*
     * (non-Javadoc)
     * @see com.liteoc.service.rule.RuleSetServiceInterface#replaceCrfOidInTargetExpression(com.liteoc.domain.rule.RuleSetBean,
     * java.lang.String)
     */

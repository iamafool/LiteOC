...
import com.liteoc.bean.extract.CommaReportBean;
...
import com.liteoc.web.job.XalanTriggerService;
        ...
        if (StringUtil.isBlank(action)) {
            ...
            if ("sas".equalsIgnoreCase(action)) {
                ...
                if (fp.getString("xalan") != null) {
                    ...
                    jobDetailBean.setJobClass(com.liteoc.web.job.XalanStatefulJob.class);

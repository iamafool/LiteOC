...
import com.liteoc.bean.admin.AuditEventBean;
import com.liteoc.bean.admin.CRFBean;
import com.liteoc.bean.admin.StudyEventAuditBean;
...
import com.liteoc.control.submit.CreateNewStudyEventServlet;
...
import com.liteoc.web.bean.DisplayStudyEventRow;
...
public class SignStudySubjectServlet extends SecureController {
    ...
    public static boolean permitSign(StudySubjectBean studySub, DataSource ds) {
        ...
        for (int l = 0; l < studyEvents.size(); l++) {
            ...
            for (int i = 0; i < eventCrfs.size(); i++) {
                ...
                // discList.get(j);
                // if
                //(discBean.getResStatus().equals(com.liteoc.bean.core
    ...
    public void processRequest() throws Exception {
        ...
        if (action.equalsIgnoreCase("confirm")) {
            ...
            // com.liteoc.core.SecurityManager

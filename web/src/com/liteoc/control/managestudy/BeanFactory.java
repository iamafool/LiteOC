 ...
 * 
 * @see com.liteoc.control.admin.SpreadsheetPreviewNw
 */
public class BeanFactory {
    public static final String UNGROUPED = "Ungrouped";
    protected static final Logger logger = LoggerFactory.getLogger("com.liteoc.control.managestudy.BeanFactory");
     ...
     * @see com.liteoc.bean.submit.ItemGroupBean

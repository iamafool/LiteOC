...
import com.liteoc.control.ListStudyView;
import com.liteoc.dao.managestudy.EventDefinitionCRFDAO;
import com.liteoc.dao.managestudy.FindSubjectsFilter;
import com.liteoc.dao.managestudy.FindSubjectsSort;
    ...
    private class ActionsCellEditor implements CellEditor {
        ...
        public Object getValue(Object item, String property, int rowcount) {
            ...
            if (studySubjectId != null) {
                ...
                url.append(PrintAllEventCRFBySubjidLinkBuilder(studySubjectBean));
                value = url.toString();
            }

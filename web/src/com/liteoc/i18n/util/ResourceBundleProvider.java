...
public class ResourceBundleProvider {
    ...
    public static void updateLocale(Locale l) {
        ...
        if (!resBundleSetMap.containsKey(l)) {
            ...
            resBundleSet.put("com.liteoc.i18n.admin", ResourceBundle.getBundle("com.liteoc.i18n.admin", l));
            resBundleSet.put("com.liteoc.i18n.audit_events", ResourceBundle.getBundle("com.liteoc.i18n.audit_events", l));
            resBundleSet.put("com.liteoc.i18n.exceptions", ResourceBundle.getBundle("com.liteoc.i18n.exceptions", l));
            resBundleSet.put("com.liteoc.i18n.format", ResourceBundle.getBundle("com.liteoc.i18n.format", l));
            resBundleSet.put("com.liteoc.i18n.page_messages", ResourceBundle.getBundle("com.liteoc.i18n.page_messages", l));
            resBundleSet.put("com.liteoc.i18n.notes", ResourceBundle.getBundle("com.liteoc.i18n.notes", l));
            resBundleSet.put("com.liteoc.i18n.terms", ResourceBundle.getBundle("com.liteoc.i18n.terms", l));
            resBundleSet.put("com.liteoc.i18n.words", ResourceBundle.getBundle("com.liteoc.i18n.words", l));
            resBundleSet.put("com.liteoc.i18n.workflow", ResourceBundle.getBundle("com.liteoc.i18n.workflow", l));
    ...
    public static String getResTerm(String key) {
        String value;
        try {
            value = getResBundle("com.liteoc.i18n.terms").getString(key);
        } catch (MissingResourceException mre) {
            value = key;
        }
        return value;
    ...
    public static String getResWord(String key) {
        String value;
        try {
            value = getResBundle("com.liteoc.i18n.words").getString(key);
        } catch (MissingResourceException mre) {
            value = key;
        }
        return value;

...
public class DynamicsItemFormMetadataDao extends AbstractDomainDao<DynamicsItemFormMetadataBean> {
    protected final org.slf4j.Logger logger = LoggerFactory.getLogger(com.liteoc.dao.hibernate.DynamicsItemFormMetadataDao.class);
    @Override
    ...
    /* (non-Javadoc)
     * @see com.liteoc.dao.hibernate.AbstractDomainDao#saveOrUpdate(com.liteoc.domain.DomainObject)

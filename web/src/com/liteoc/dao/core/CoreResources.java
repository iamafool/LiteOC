...
import com.liteoc.bean.service.PdfProcessingFunction;
import com.liteoc.bean.service.SasProcessingFunction;
import com.liteoc.bean.service.SqlProcessingFunction;
...
public class CoreResources implements ResourceLoaderAware {
    ...
    protected final static Logger logger = LoggerFactory.getLogger("com.liteoc.dao.core.CoreResources");
    ...
    private void copyODMMappingXMLtoResources(ResourceLoader resourceLoader) {
        ...
        try {
            ...
            File placeholder_file = new File(resourceLoader.getResource("classpath:com/liteoc/applicationContext-web-beans.xml").getURL().getFile());

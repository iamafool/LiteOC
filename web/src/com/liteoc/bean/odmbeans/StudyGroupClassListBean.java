...
public class StudyGroupClassListBean {
    ...
    private List<com.liteoc.bean.odmbeans.StudyGroupItemBean> studyGroupItems;

    public StudyGroupClassListBean() {
        studyGroupItems = new ArrayList<com.liteoc.bean.odmbeans.StudyGroupItemBean>();
    }
    ...
    public void setStudyGroupItems(List<com.liteoc.bean.odmbeans.StudyGroupItemBean> studyGroupItems) {
        this.studyGroupItems = studyGroupItems;
    }

    public List<com.liteoc.bean.odmbeans.StudyGroupItemBean> getStudyGroupItems() {

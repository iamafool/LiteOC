...
public class EventCRFBean extends AuditableEntityBean {
    ...
    private com.liteoc.domain.Status nexGenStatus;
    ...
    public EventCRFBean() {
        ...
        nexGenStatus = com.liteoc.domain.Status.INVALID;
    }
    ...
    public com.liteoc.domain.Status getNexGenStatus() {
        return nexGenStatus;
    }

    public void setNexGenStatus(com.liteoc.domain.Status nexGenStatus) {

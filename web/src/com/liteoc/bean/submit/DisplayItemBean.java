...
import com.liteoc.service.crfdata.SCDData;
...
public class DisplayItemBean implements Comparable {
    ...
    public void setMetadata(ItemFormMetadataBean metadata) {
        ...
        if (rt.equals(com.liteoc.bean.core.ResponseType.CHECKBOX) || rt.equals(com.liteoc.bean.core.ResponseType.RADIO) 
            || rt.equals(com.liteoc.bean.core.ResponseType.SELECT) || rt.equals(com.liteoc.bean.core.ResponseType.SELECTMULTI)) {
    ...
    public void loadFormValue(String value) {
        ...
        if (rt.equals(com.liteoc.bean.core.ResponseType.TEXT) || rt.equals(com.liteoc.bean.core.ResponseType.TEXTAREA) //|| rt.equals(com.liteoc.bean.core.ResponseType.CODING)
            || rt.equals(com.liteoc.bean.core.ResponseType.CALCULATION) || rt.equals(com.liteoc.bean.core.ResponseType.GROUP_CALCULATION)
    ...
    public void loadDBValue() {
        ...
        } else if (rt.equals(com.liteoc.bean.core.ResponseType.TEXT) || rt.equals(com.liteoc.bean.core.ResponseType.TEXTAREA) //|| rt.equals(com.liteoc.bean.core.ResponseType.CODING)
            || rt.equals(com.liteoc.bean.core.ResponseType.CALCULATION) || rt.equals(com.liteoc.bean.core.ResponseType.GROUP_CALCULATION)) {
            rsb.setValue(dbValue);
        } else if (rt.equals(com.liteoc.bean.core.ResponseType.FILE)) {

...
public class ResponseSetBean extends EntityBean {
    ...
    private com.liteoc.bean.core.ResponseType responseType;
    ...
    public ResponseSetBean() {
        super();
        setResponseType(com.liteoc.bean.core.ResponseType.TEXT);
     ...
     */
    public com.liteoc.bean.core.ResponseType getResponseType() {
        return responseType;
    }
     ...
     */
    public void setResponseType(com.liteoc.bean.core.ResponseType responseType) {
    ...
    public void setResponseTypeId(int responseTypeId) {
        responseType = com.liteoc.bean.core.ResponseType.get(responseTypeId);
    }

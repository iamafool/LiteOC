 ...
 */
package com.liteoc.bean.managestudy;
 ...
 * @author jxu
 */
public class EventDefinitionCRFBean extends AuditableEntityBean implements
		Comparable {
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((defaultVersionName == null) ? 0 : defaultVersionName
						.hashCode());
		...
		result = prime * result
				+ ((nullFlags == null) ? 0 : nullFlags.hashCode());
		result = prime * result
				+ ((nullValues == null) ? 0 : nullValues.hashCode());
		result = prime * result
				+ ((nullValuesList == null) ? 0 : nullValuesList.hashCode());
		...
		result = prime
				* result
				+ ((selectedVersionIdList == null) ? 0 : selectedVersionIdList
						.hashCode());
		result = prime
				* result
				+ ((selectedVersionIds == null) ? 0 : selectedVersionIds
						.hashCode());
		result = prime
				* result
				+ ((selectedVersionNames == null) ? 0 : selectedVersionNames
						.hashCode());
		result = prime
				* result
				+ ((sourceDataVerification == null) ? 0
						: sourceDataVerification.hashCode());
		result = prime * result + studyEventDefinitionId;
		result = prime * result + studyId;
		result = prime * result
				+ ((versions == null) ? 0 : versions.hashCode());
		result = prime * result + doubleEntryType;
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (doubleEntry != other.doubleEntry)
			return false;
		if (doubleEntryType != other.doubleEntryType)
			return false;
	...
	// This value must match what is in the database presently, which are mostly
	// blank values
	private SourceDataVerification sourceDataVerification = null;

	// private SourceDataVerification sourceDataVerification =
	...
	public void setNullValues(String nullValues) {
		...
		if (nullValuesSeparated != null) {
			for (String val : nullValuesSeparated) {
				com.liteoc.bean.core.NullValue nv = com.liteoc.bean.core.NullValue
						.getByName(val);
				if (nv.isActive()) {
	...
	public void setSourceDataVerification(
	...
	public void setSelectedVersionIdList(
			ArrayList<Integer> selectedVersionIdList) {
	...
	public int getDoubleEntryType() {
		return doubleEntryType;
	}

	public void setDoubleEntryType(int doubleEntryType) {

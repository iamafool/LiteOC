...
public class EmailHandler extends GeneralizedFieldHandler {
    ...
    public Object convertUponSet(Object value) {
        ...
        for (String email : emails) {
            areEmailsValid = EmailValidator.getInstance().isValid(email);
            if (!areEmailsValid) {
                throw new OpenClinicaSystemException("Email Address : \"" + value
                    + " \" you provided is not Valid, Please provide valid comma seperated email addresses.");
            }
        }
        return value;
    }

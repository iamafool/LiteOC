...
<jsp:useBean scope='request' id='filter' class='com.liteoc.bean.extract.FilterBean' />
...
<h1><span class="title_manage"><fmt:message key="edit_filter" bundle="${resword}"/>: <c:out value="${filter.name}"/></span></h1>

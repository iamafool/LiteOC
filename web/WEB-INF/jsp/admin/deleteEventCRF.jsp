...
<jsp:useBean scope="request" id="displayEventCRF" class="com.liteoc.bean.submit.DisplayEventCRFBean"/>
<jsp:useBean scope="request" id="event" class="com.liteoc.bean.managestudy.StudyEventBean"/>

...
<jsp:useBean scope="session" id="newUserBean" class="com.liteoc.bean.login.UserAccountBean"/>
...
<h1><span class="title_manage"><fmt:message key="contact_administrator" bundle="${restext}"/></span></h1>

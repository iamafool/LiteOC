...
<form id="mainForm" name="crfForm" method="post" action="AdministrativeEditing2" onLoad="javascript:leftnavExpand('CRF_infobox_open');"> 
...
<script type="text/JavaScript" language="JavaScript">
    ...
    function DisplaySectionTabs()
    {
...

        {
            ...
            url = "AdministrativeEditing2?eventCRFId=" + <c:out value="${section.eventCRF.id}"/> + "&sectionId=" + sectionId + "&tab=" + TabID + "&exitTo=${exitTo}";
...
<td>&nbsp;
    <div class="formfieldM_BG_noMargin"><select class="formfieldM" name="sectionName" size="1" onchange="gotoLink();">
        ...
        <c:forEach var="sec" items="${toc.sections}" >
            <c:set var="tabUrl" value = "AdministrativeEditing2?eventCRFId=${section.eventCRF.id}&sectionId=${sec.id}&tab=${tabCount}&exitTo=${exitTo}"/>
                        ...
                        <c:choose>
                            ...
                            <td valign="top" nowrap="nowrap">
                                ...
                                <c:import url="../submit/showItemInput.jsp">
                                    ...
                                    <c:param name="originJSP" value="administrativeEditing"/>
                                    <%-- <c:param name="isForcedRFC" value="${study.studyParameterConfig.adminForcedReasonForChange}"/> --%>
                                    <c:param name="isForcedRFC" value="false"/>
                                </c:import>
                    ...
                    <td valign="top">
                        <table border="0">
                            <tr>
                                ...
                                <%--BWP: try this--%>
                            <tr>
                                <td valign="top" colspan="4" style="text-align:right"> error1:

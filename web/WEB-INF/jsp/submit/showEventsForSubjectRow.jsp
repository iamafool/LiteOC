...
<%@ page import="com.liteoc.bean.core.DataEntryStage"%>
<%@ page import="com.liteoc.bean.core.SubjectEventStatus"%>
...
<jsp:useBean scope="request" id="currRow" class="com.liteoc.web.bean.DisplayStudySubjectEventsRow" />

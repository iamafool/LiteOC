...
<jsp:directive.page import="com.liteoc.bean.core.SubjectEventStatus"/>
...
<jsp:useBean scope="request" id="currEvent" class="com.liteoc.bean.managestudy.StudyEventBean" />

<%--
<jsp:useBean scope="request" id="eventStatus" class="com.liteoc.bean.core.SubjectEventStatus" />
--%>
	 ...
	 <c:otherwise>
	   	<a href="javascript:leftnavExpand('Menu_on_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>'); 
		     ...
		     onmouseover="layersShowOrHide('visible','Event_<c:out value="${subjectName}"/>_<c:out value="${count}"/>_<c:out value="${eblRowCount}"/>');
				...
				>
				<img src="images/spacer.gif" border="0" height="30" width="50">
				</a>
